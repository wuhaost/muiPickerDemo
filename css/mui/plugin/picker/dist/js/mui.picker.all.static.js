...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		...
		<div class="mui-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5><h5 data-id="title-q">季</h5></div>\
		<div class="mui-dtpicker-body">\
			...
			<div data-id="picker-q" class="mui-picker">\
				<div class="mui-picker-inner">\
					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
					<ul class="mui-pciker-list">\
					</ul>\
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		...
		getSelected: function() {
			...
			switch (type) {
				...
				case 'hour':
					...
					break;
				case 'quarter':
					selected.value = selected.y.value + '-' + selected.q.value;
					selected.text = selected.y.text + '-' + selected.q.text;
					break;
			}
			return selected;
		},
				...
				ui.m.picker.setSelectedValue(parsedValue.m, 0, function() {
					ui.d.picker.setSelectedValue(parsedValue.d, 0, function() {
						ui.h.picker.setSelectedValue(parsedValue.h, 0, function() {
							ui.i.picker.setSelectedValue(parsedValue.i, function(){
								ui.q.picker.setSelectedValue(parsedValue.q, 0);
							});
						});
					});
				});
		...
		_createQuarter: function(current) {
			var self = this;
			var options = self.options;
			var ui = self.ui;
			//生成季列表
			...
			ui.q.picker.setItems(qArray);
			ui.q.picker.setSelectedValue('Q4');
		},
		...
		_create: function(options) {
			var self = this;
			options = options || {};
			options.labels = options.labels || ['年', '月', '日', '时', '分', '季'];
